...
SoftwareRenderer::SoftwareRenderer()
{
	functionLamda = [this](int xCoord, int yCoord, Rgb* fetchTexture, Rgb* rasterizedTexture, Triangle triangle)
	{
		...
		Vector3 fLight(20.0f, 50.0f, 35.0f);
		//Vector3 fLight(50.0f, 50.0f, 35.0f);

		Vector3 fVertexRelativePosition(xCoord - fLight.x, yCoord - fLight.y, 0.0f - fLight.z);
